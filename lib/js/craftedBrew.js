var $ = jQuery.noConflict();
	...
	$(document).ready(function() {
        ...
        $(".eme-calendar-full").addClass('table-responsive');
        $(".table-responsive").find('.eme-calendar-table').addClass('table table-light');
        $(".table-light").removeClass('eme-calendar-table');
        $(".table-responsive").removeClass('eme-calendar-full');
        $('.eme-calendar-table').find('thead').addClass('thead-light');
        $(".eme-calendar-day-event").addClass('bg-info').css('list-style-type', 'none');
        $(".prev-month, .next-month").addClass('btn btn-warning').css('font-weight', 'bold');
        $(".month_name").addClass('h4');
        $(".days-names").addClass('bg-dark text-white');
        $(".eventless-today").addClass('badge badge-pill badge-light');
